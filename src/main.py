...
if __name__ == "__main__":
    ...
    gui_window.title("To-do 0.0.1")

    width = gui_window.winfo_screenwidth()
    height = gui_window.winfo_screenheight()
    gui_window.geometry("%dx%d" % (width, height))
    gui_window.configure(bg="#FFF8E7")
    ...
    header_frame = tk.Frame(gui_window, bg="#FFF8E7")
    functions_frame = tk.Frame(gui_window, bg="#FFF8E7")
    listbox_frame = tk.Frame(gui_window, bg="#FFF8E7")
